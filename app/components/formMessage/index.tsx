...
import { SmileOutlined, SendOutlined, UploadOutlined, CloseOutlined } from '@ant-design/icons';
...
export const FormMessage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <button type="submit" className={styles.sendButton} disabled={!message.trim() && !image}>
        <SendOutlined />
      </button>
    </form>
  );
